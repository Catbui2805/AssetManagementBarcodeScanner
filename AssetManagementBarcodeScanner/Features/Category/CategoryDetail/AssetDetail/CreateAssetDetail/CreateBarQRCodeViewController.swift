//
//  CreateBarQRCodeViewController.swift
...
class CreateBarQRCodeViewController: UIViewController {
    ...
    static let identifier: String = "CreateBarQRCodeViewController"
...
private extension CreateBarQRCodeViewController {
    func setupViews() {
...
extension CreateBarQRCodeViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
